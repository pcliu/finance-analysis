...
# 持仓详情 (3/4 盘前截图数据 - 基于3/3收盘)
# 注意: 3/2消费ETF减仓25000股(卖出10000@0.5370 + 卖出15000@0.5320), 剩余13000股
HOLDINGS = {
    '510150': {'shares': 13000, 'cost': 0.5980, 'current': 0.5260, 'market_value': 6838, 'pnl': -937.00, 'pnl_pct': -12.04, 'position_pct': 6.47},
    '510880': {'shares': 10000, 'cost': 3.0671, 'current': 3.3670, 'market_value': 33670, 'pnl': 2997.32, 'pnl_pct': 9.78, 'position_pct': 31.86},
    '512170': {'shares': 14000, 'cost': 0.3585, 'current': 0.3390, 'market_value': 4746, 'pnl': -273.50, 'pnl_pct': -5.44, 'position_pct': 4.49},
    '512660': {'shares': 8000, 'cost': 1.5128, 'current': 1.4790, 'market_value': 11832, 'pnl': -270.59, 'pnl_pct': -2.23, 'position_pct': 11.20},
    '513180': {'shares': 5000, 'cost': 0.7001, 'current': 0.6340, 'market_value': 3170, 'pnl': -331.00, 'pnl_pct': -9.44, 'position_pct': 3.00},
    '515050': {'shares': 1000, 'cost': 2.3200, 'current': 2.3660, 'market_value': 2366, 'pnl': 45.50, 'pnl_pct': 1.98, 'position_pct': 2.24},
    '515070': {'shares': 400, 'cost': 1.9388, 'current': 1.9460, 'market_value': 778.40, 'pnl': 2.40, 'pnl_pct': 0.37, 'position_pct': 0.74},
    '515790': {'shares': 1000, 'cost': 1.1005, 'current': 1.1100, 'market_value': 1110, 'pnl': 9.00, 'pnl_pct': 0.86, 'position_pct': 1.05},
    '588000': {'shares': 1000, 'cost': 0.3019, 'current': 1.4640, 'market_value': 1464, 'pnl': 1161.60, 'pnl_pct': 384.93, 'position_pct': 1.39},
    '159241': {'shares': 8000, 'cost': 1.5185, 'current': 1.4800, 'market_value': 11840, 'pnl': -308.59, 'pnl_pct': -2.54, 'position_pct': 11.20},
    '159770': {'shares': 200, 'cost': 0.7670, 'current': 1.0440, 'market_value': 208.80, 'pnl': 54.90, 'pnl_pct': 36.11, 'position_pct': 0.20},
}

AVAILABLE_CASH = 27648.28  # 可用资金
...
def analyze_single(code, name):
    ...
    try:
        ...
        result = {
            ...
            'rsi_change_5d': round(float(rsi_change_5d), 1),
            ...
            'hist_prev': round(float(hist_prev), 4),
            'macd_status': macd_status,
            'is_golden': bool(is_golden),
            'golden_cross_today': bool(golden_cross_today),
            'death_cross_today': bool(death_cross_today),
