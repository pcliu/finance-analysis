...
This is a reusable workflow that can be saved and reused across sessions.

Usage:
    from workflows.analyze_and_save import analyze_and_save
...
from scripts import fetch_stock_data, get_company_info
from scripts import calculate_rsi, calculate_sma, calculate_macd
from scripts import calculate_max_drawdown
